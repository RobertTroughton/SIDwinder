...
java -jar .\KickAss.jar :loadAddress=16384 :sysAddress=16640 :dataAddress=16384 .\SIDPlayers\RaistlinTripleHybridBars\RaistlinTripleHybridBars.asm -showmem -binfile -o public\prg\RaistlinTripleHybridBars-4000.bin || goto :error
java -jar .\KickAss.jar :loadAddress=16384 :sysAddress=16640 :dataAddress=16384 .\SIDPlayers\RaistlinVerticalColours\RaistlinVerticalColours.asm -showmem -binfile -o public\prg\RaistlinVerticalColours-4000.bin || goto :error
...
java -jar .\KickAss.jar :loadAddress=32768 :sysAddress=33024 :dataAddress=32768 .\SIDPlayers\RaistlinTripleHybridBars\RaistlinTripleHybridBars.asm -showmem -binfile -o public\prg\RaistlinTripleHybridBars-8000.bin || goto :error
java -jar .\KickAss.jar :loadAddress=32768 :sysAddress=33024 :dataAddress=32768 .\SIDPlayers\RaistlinVerticalColours\RaistlinVerticalColours.asm -showmem -binfile -o public\prg\RaistlinVerticalColours-8000.bin || goto :error
