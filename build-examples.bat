...
SIDwinder.exe -player=RaistlinBarsWithLogo -define LogoKoala="../../Logos/facet-acrouzet.kla" SID/acrouzet-soulspace.sid examples/acrouzet-soulspace.prg
...
SIDwinder.exe -player=RaistlinBarsWithLogo -define LogoKoala="../../Logos/redcrab-celticdesign2.kla" SID/celticdesign-blueearth.sid examples/celticdesign-blueearth.prg
...
SIDwinder.exe -player=RaistlinBarsWithLogo -define LogoKoala="../../Logos/redcrab-mch.kla" SID/mch-chordexplorer.sid examples/mch-chordexplorer.prg
...
SIDwinder.exe -player=RaistlinBarsWithLogo -define LogoKoala="../../Logos/facet-mrmouse.kla" SID/mrmouse-downhill.sid examples/mrmouse-downhill.prg
...
SIDwinder.exe -player=RaistlinBarsWithLogo -define LogoKoala="../../Logos/redcrab-steel.kla" SID/steel-92littleshortyrockers.sid examples/steel-92littleshortyrockers.prg
...
SIDwinder.exe -player=RaistlinBarsWithLogo -define LogoKoala="../../Logos/facet-stinsen.kla" SID/stinsen-diagonality.sid examples/stinsen-diagonality.prg
...
SIDwinder.exe -player=RaistlinBars SID/drax-expand.sid examples/drax-expand.prg
...
SIDwinder.exe -player=RaistlinBars SID/jammer-mm.sid examples/jammer-mm.prg
SIDwinder.exe -player=RaistlinBars SID/jammer-soccer.sid examples/jammer-soccer.prg
SIDwinder.exe -player=RaistlinBars SID/jch-crystalline.sid examples/jch-crystalline.prg
SIDwinder.exe -player=RaistlinBars SID/magnar-airwolf.sid examples/magnar-airwolf.prg
SIDwinder.exe -player=RaistlinBars SID/magnar-firestarter.sid examples/magnar-firestarter.prg
...
SIDwinder.exe -player=RaistlinBars SID/magnar-wonderland12.sid examples/magnar-wonderland12.prg
...
SIDwinder.exe -player=RaistlinBars SID/tc87-crockets.sid examples/tc87-crockets.prg
SIDwinder.exe -player=RaistlinBars SID/toggle-fireflies.sid examples/toggle-fireflies.prg
SIDwinder.exe -player=RaistlinBars SID/trident-sptest07.sid examples/trident-sptest07.prg
SIDwinder.exe -player=RaistlinBars SID/xiny-allstars.sid examples/xiny-allstars.prg
