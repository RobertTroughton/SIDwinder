...
SIDwinder.exe -player=RaistlinBarsWithLogo -define LogoKoala="../../Logos/redcrab-steel.kla" SID/steel-92littleshortyrockers.sid examples/steel-92littlefshortyrockers.prg
