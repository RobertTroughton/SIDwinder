...
SIDwinder.exe -player=RaistlinBarsWithLogo SID/drax-expand.sid examples/drax-expand.prg
...
SIDwinder.exe -player=RaistlinBarsWithLogo SID/magnar-wonderland12.sid examples/magnar-wonderland12.prg
